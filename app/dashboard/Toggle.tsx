...
const Toggle = ({ deletePost, setToggle }: ToggleProps) => {
    return (
        ...
        >
            <div className="absolute bg-white top-1/2  left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-14 rounded-lg flex flex-col gap-6">
                <h2 className="sm:text-lg text-sm font-bold">
                    Are you sure you want to dele this post 😢?
                </h2>
                <h3 className="text-red-600 text-sm ">
                    Pressing the delete button will permanently delete your
                    post.
                </h3>
                <button
                    onClick={deletePost}
